...
K       = 39                     # Number of kinetic parameters
...
## Batch run
resfun = lambda p : quanser.batch_residuals_ModC(all_detections=all_detections, p=p, K=K)
p = least_squares(resfun, x0=p, jac_sparsity=sparse, verbose=2, max_nfev=600).x
...
plt.savefig('out_part3_Mod-C.png')
plt.show()
